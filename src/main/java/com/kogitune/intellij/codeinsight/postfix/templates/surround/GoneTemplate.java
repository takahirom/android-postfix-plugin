 ...
 * @author axlchen
 */
public class GoneTemplate extends AbstractRichStringBasedPostfixTemplate {

    public GoneTemplate() {
        this("gone");
    }

    public GoneTemplate(@NotNull String alias) {
        super(alias, "view.setVisibility(View.GONE)", IS_VIEW);
    }
