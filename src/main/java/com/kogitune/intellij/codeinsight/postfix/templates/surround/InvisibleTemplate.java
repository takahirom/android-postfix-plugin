 ...
 * @author axlchen
 */
public class InvisibleTemplate extends AbstractRichStringBasedPostfixTemplate {

    public InvisibleTemplate() {
        this("invsb");
    }

    public InvisibleTemplate(@NotNull String alias) {
        super(alias, "view.setVisibility(View.INVISIBLE)", IS_VIEW);
    }

    @Override
    public String getTemplateString(@NotNull PsiElement element) {
        return "$view$.setVisibility(View.INVISIBLE)";
    }
